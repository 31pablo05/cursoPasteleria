  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute top-0 left-1/4 w-64 h-64 bg-gradient-to-r from-pink-500/10 to-purple-500/10 rounded-full"
          animate={{ rotate: 360, scale: [1, 1.2, 1] }}
          transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
        />
        <motion.div
          className="absolute bottom-0 right-1/4 w-48 h-48 bg-gradient-to-l from-blue-500/8 to-indigo-500/8 rounded-full"
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
            ...
            >
              ...
              >
                <div className="flex gap-2">
                  <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <FaCookie className="text-4xl text-pink-400" />
                  </motion.div>
                  <motion.div
                    whileHover={{ rotate: -15 }}
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <FaCubes className="text-4xl text-purple-400" />
                  </motion.div>
                </div>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span>info@cursopasteleria.com</span>
                </motion.div>
                <motion.div
                  whileHover={{ x: 5 }}
                  className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors duration-300"
                >
                  ...
                  <span>123 Calle Dulce, Ciudad Pastelera</span>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              <h4 className="text-xl font-bold text-white mb-8 relative">
                Nuestro Curso
                <div className="absolute -bottom-2 left-0 w-12 h-1 bg-gradient-to-r from-pink-400 to-purple-400 rounded-full" />
              </h4>
                ...
                {footerLinks.course.map((link, index) => (
                  ...
                  >
                    <Link
                      ...
                      smooth={true}
                      duration={500}
                      className="text-gray-300 hover:text-pink-400 transition-colors duration-300 cursor-pointer block"
                    >
                      {link.name}
                    </Link>
                  </motion.li>
            ...
            >
              <h4 className="text-xl font-bold text-white mb-8 relative">
                Información
                <div className="absolute -bottom-2 left-0 w-12 h-1 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full" />
              </h4>
              <ul className="space-y-4">
                  ...
                  >
                    {link.to.startsWith('#') ? (
                      ...
                      <Link
                        ...
                        smooth={true}
                        duration={500}
                        className="text-gray-300 hover:text-blue-400 transition-colors duration-300 cursor-pointer block"
                      >
                        {link.name}
                      </Link>
                    )}
        ...
        >
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
              ...
              <div className="flex justify-center lg:justify-start gap-6">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className={`w-12 h-12 bg-gray-800 rounded-xl flex items-center justify-center text-gray-400 transition-all duration-300 ${social.color} hover:bg-gray-700`}
                  >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="bg-gradient-to-r from-pink-500 to-purple-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:from-pink-600 hover:to-purple-700"
            >
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
            <p className="text-gray-400 flex items-center gap-2">
              © {currentYear} Curso de Pastelería. Hecho con 
              <motion.span
              ...
              para pasteleros apasionados. Desarrollado por{' '}
              <a
